          ...
          linear-gradient(90deg, rgba(255,255,255,0.02) 1px, transparent 1px)`,
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '13px', color: 'rgba(148,163,184,0.5)', fontWeight: '500', letterSpacing: '0.3px', lineHeight: 1.6 }}>
                        Designed & Maintained with <span style={{ color: '#ef4444', fontSize: '15px' }}>❤️</span> by{' '}
                        <span style={{ fontWeight: '700', color: 'rgba(148,163,184,0.7)' }}>Ojas Gupta</span>
                    </p>
                    <a
                        ...
                        style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(148,163,184,0.4)', transition: 'all 0.25s ease' }}
